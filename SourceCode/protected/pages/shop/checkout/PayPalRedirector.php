...
class PayPalRedirector extends TPage
{
	...
	public function onLoad($param)
	{
		...
		if (!$this->IsPostBack)
		{
			...
			$this->PPayPal1->ReturnUrl = $this->Service->ConstructUrl("shop.checkout.Confirmation",array("hash"=>$this->generateHash($this->Order->ID,$this->Order->Num,$this->Payment->ID)));
		}
	}

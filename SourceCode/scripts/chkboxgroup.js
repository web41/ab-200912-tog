...
/*function CBG_toogle(obj,value)
{
	if (this.formRef==null) 
	{
		this.formRef=obj.form;
		this.expandWildcards();
		//if (this.controlBox==null || obj.name!=this.controlBox) {this.totalSelected += (checked)?-1:1;}
	}
	if (this.masterBehavior=="all") 
	{
		for (i=0;i<this.checkboxNames.length;i++) {this.checkboxNames[i].checked=value;}
		this.totalSelected=(value)?this.checkboxNames.length:0;
	}
}*/

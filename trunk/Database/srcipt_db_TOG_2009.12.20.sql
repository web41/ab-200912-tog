...
CREATE TABLE `tbl_brand` (
  ...
  `brand_alias` varchar(255) NOT NULL DEFAULT '',
...
insert  into `tbl_brand`(`brand_id`,`brand_alias`,`brand_name`) values (0,'',''),(1,'napster','Napster'),(2,'olympus','Olympus'),(3,'sony','SONY'),(4,'seagate','Seagate'),(5,'ea-sports','EA Sports'),(6,'kodak','Kodak'),(7,'samsung','Samsung'),(8,'microsoft','Microsoft'),(9,'hbo','HBO'),(10,'pny','PNY'),(11,'intel','Intel'),(12,'garmin','GARMIN'),(13,'western-digital','Western Digital'),(14,'sandisk','SanDisk'),(15,'symantec','Symantec'),(16,'ulead','Ulead'),(17,'toshiba','Toshiba');
...
insert  into `tbl_manufacturer`(`mf_id`,`mf_alias`,`mf_name`,`mf_desc`,`mf_email`,`mf_url`) values (0,'','',NULL,'',''),(1,'','Accura Electrods India Pvt.,Ltd.','Accura Electrods India Pvt.,Ltd.','',''),(2,'','Perbru Corporation','Perbru Corporation','',''),(3,'','Shenzhen Sansun Hi-Tech Co.,Ltd','Shenzhen Sansun Hi-Tech Co.,Ltd','',''),(4,'','Netmus Electronic Technology Co.,Ltd','Netmus Electronic Technology Co.,Ltd','','');
...
CREATE TABLE `tbl_order` (
  ...
  KEY `FK_tbl_order_b_country_code` (`b_country_code`),
  KEY `FK_tbl_order_s_country_code` (`s_country_code`),
  CONSTRAINT `FK_tbl_order_b_country_code` FOREIGN KEY (`b_country_code`) REFERENCES `tbl_country` (`country_code`),
  ...
  CONSTRAINT `FK_tbl_order_s_country_code` FOREIGN KEY (`s_country_code`) REFERENCES `tbl_country` (`country_code`),
...
CREATE TABLE `tbl_order_history` (
  ...
  KEY `FK_tbl_order_history_order_status_code` (`order_status_code`),
  CONSTRAINT `FK_tbl_order_history_order_id` FOREIGN KEY (`order_id`) REFERENCES `tbl_order` (`order_id`) ON DELETE CASCADE,
  CONSTRAINT `FK_tbl_order_history_order_status_code` FOREIGN KEY (`order_status_code`) REFERENCES `tbl_order_status` (`status_code`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `tbl_payment_method` (
  ...
  `method_alias` varchar(255) NOT NULL DEFAULT '',
...
insert  into `tbl_payment_method`(`method_id`,`method_alias`,`method_name`,`method_publish`) values (0,'','',0);
...
insert  into `tbl_product`(`product_id`,`mf_id`,`brand_id`,`discount_id`,`product_alias`,`product_sku`,`product_name`,`product_brief`,`product_desc`,`product_image`,`product_thumb`,`product_price`,`product_reward_points`,`product_best_seller`,`product_hot_deal`,`product_new_arrival`,`product_publish`,`product_order`,`product_in_stock`,`product_uom`,`product_available_date`,`c_date`,`m_date`) values (0,0,0,0,'','','',NULL,NULL,'','','0.00000',0,0,0,1,1,0,99,'',0,0,0);
...
insert  into `tbl_product_cat_xref`(`product_id`,`cat_id`) values (0,0);
...
CREATE TABLE `tbl_product_discount` (
  ...
  `discount_alias` varchar(255) NOT NULL DEFAULT '',
...
insert  into `tbl_product_discount`(`discount_id`,`discount_alias`,`discount_name`,`discount_amount`,`is_percent`,`s_date`,`e_date`) values (0,'','','0.00000',0,0,0);
...
insert  into `tbl_shipping_method`(`method_id`,`method_alias`,`method_name`,`discount_id`,`method_price`,`method_publish`) values (0,'','',0,'0.00000',0);
...
CREATE TABLE `tbl_user` (
  ...
  `ip_address` varchar(20) NOT NULL DEFAULT '',
  `last_visit_ip` varchar(20) NOT NULL DEFAULT '',
  `last_visit_date` int(10) unsigned NOT NULL DEFAULT '0',
  `c_date` int(10) unsigned NOT NULL DEFAULT '0',
  `m_date` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`user_id`),
...
insert  into `tbl_user`(`user_id`,`user_name`,`user_pwd`,`user_email`,`user_type_id`,`user_credits`,`user_status`,`user_hash`,`ip_address`,`last_visit_ip`,`last_visit_date`,`c_date`,`m_date`) values (0,'','','',0,0,0,'','','',0,0,0),(1,'alex','alex','alex@phoenix-solution.com',5,999,1,'','192.168.1.1','192.168.1.1',0,0,0);
...
CREATE TABLE `tbl_user_address` (
  ...
  `address_alias` varchar(255) NOT NULL DEFAULT '',
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  ...
  KEY `FK_tbl_user_address_country_code` (`country_code`),
  CONSTRAINT `FK_tbl_address_user_id` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`) ON DELETE CASCADE,
  CONSTRAINT `FK_tbl_user_address_country_code` FOREIGN KEY (`country_code`) REFERENCES `tbl_country` (`country_code`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `tbl_user_type` (
  ...
  `user_type_alias` varchar(50) NOT NULL DEFAULT '',
...
insert  into `tbl_user_type`(`user_type_id`,`user_type_alias`,`user_type_name`) values (0,'','Unused'),(1,'','Guest'),(2,'','Banned'),(3,'','Registered'),(4,'','Manager'),(5,'','Administrator');

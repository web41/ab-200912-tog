                	...
                	<tr>
                    	<td style="vertical-align:bottom">
                        	<div class="box">
                                ...
                                <div class="content">
                                	Hello, <span class="username"><%= $this->Application->User->Email %></span> ::<com:TLinkButton Text="Logout" OnClick="btnLogout_Clicked" />::<a href="<%= $this->Service->ConstructUrl("shop.Index",array("new_arrival"=>1)) %>" target="_blank">Homepage</a>
                                </div>
                            </div>
                        </td>
                    </tr>
